...
(function() {
    ...
    function h(a, c, b) {
        ...
        this.editor = a;
        this.lang = a.lang;
        "string" === typeof c ? (this.data = c, this.file = m(this.data), this.loaded = this.total = this.file.size) : (this.data = null, this.file = c, this.total = this.file.size, this.loaded = 0);
    ...
    CKEDITOR.plugins.add("filetools", {
        lang: "cs,da,de,de-ch,en,eo,es,eu,fr,gl,id,it,km,ko,ku,nb,nl,pl,pt,pt-br,ru,sv,tr,ug,uk,zh,zh-cn",
        beforeInit: function(a) {
            ...
            a.on("fileUploadResponse", function(a) {
                ...
                try {
                    ...
                    f.uploaded ? (e.fileName = f.fileName, e.url = f.url) : a.cancel()
                } catch (k) {
                    e.message =
                        b.lang.filetools.responseError, CKEDITOR.warn("filetools-response-error", {
    ...
    h.prototype = {
        ...
        upload: function(a) {
            a ?
                (this.uploadUrl = a, this.xhr = new XMLHttpRequest, this.attachRequestListeners(), this.editor.fire("fileUploadRequest", {
                    fileLoader: this
                ...
                if ("abort" != b.status)
                    if (b.uploaded = b.uploadTotal, 200 > d.status || 299 < d.status) b.message = b.lang.filetools["httpError" + d.status], b.message || (b.message = b.lang.filetools.httpError.replace("%1", d.status)), b.changeStatus("error");
                        ...
                        for (var a = {
                                ...
                                "fileName", "url"
                            ], k = b.editor.fire("fileUploadResponse", a), g = 0; g < c.length; g++) {
                            var h = c[g];
