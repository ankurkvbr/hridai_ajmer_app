            ...
            if (CKEDITOR.plugins.clipboard.isFileApiSupported) {
                ...
                h ? (f.addUploadWidget(d, "uploadimage", {
                    ...
                    onUploaded: function(a) {
                        this.replaceWith('\x3cimg src\x3d"' + a.url + '" width\x3d"' + this.parts.img.$.naturalWidth + '" height\x3d"' + this.parts.img.$.naturalHeight + '"\x3e')
                    }
                    ...
                    if (a.data.dataValue.match(/<img[\s\S]+data:/i)) {
                        ...
                        for (g = 0; g < l.count(); g++) {
                            ...
                            e && k && !b.data("cke-upload-id") && !b.isReadOnly(1) && (e = d.uploadRepository.create(b.getAttribute("src")), e.upload(h), f.markElement(b, "uploadimage", e.id), f.bindNotifications(d, e))
                        }
