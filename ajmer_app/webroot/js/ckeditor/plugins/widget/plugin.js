...
(function() {
    ...
    function n(a, b, c, d) {
        var e = a.editor;
        e.fire("lockSnapshot");
        c ? (d = c.data("cke-widget-editable"), d = b.editables[d], a.widgetHoldingFocusedEditable = b, b.focusedEditable = d, c.addClass("cke_widget_editable_focused"), d.filter && e.setActiveFilter(d.filter),
            e.setActiveEnterMode(d.enterMode, d.shiftEnterMode)) : (d || b.focusedEditable.removeClass("cke_widget_editable_focused"), b.focusedEditable = null, a.widgetHoldingFocusedEditable = null, e.setActiveFilter(null), e.setActiveEnterMode(null, null));
    ...
    function L(a) {
        ...
        b.on("drop", function(c) {
            var e = c.data.dataTransfer,
                ...
                e = b.createRange();
            "" !== f && h === CKEDITOR.DATA_TRANSFER_CROSS_EDITORS ? c.cancel() : "" !== f && h == CKEDITOR.DATA_TRANSFER_INTERNAL && (f = a.instances[f]) && (e.setStartBefore(f.wrapper), e.setEndAfter(f.wrapper), c.data.dragRange = e, delete CKEDITOR.plugins.clipboard.dragStartContainerChildCount,
                delete CKEDITOR.plugins.clipboard.dragEndContainerChildCount, c.data.dataTransfer.setData("text/html", b.editable().getHtmlFromRange(e).getHtml()), b.widgets.destroy(f, !0))
        });
        b.on("contentDom", function() {
            ...
            CKEDITOR.tools.extend(a, {
                finder: new c.finder(b, {
                    lookups: {
                        "default": function(c) {
                            if (!c.is(CKEDITOR.dtd.$listItem) && c.is(CKEDITOR.dtd.$block) && !g.isDomNestedEditable(c) && !a._.draggedWidget.wrapper.contains(c)) {
    ...
    function J(a) {
        ...
        b.on("doubleclick", function(c) {
            ...
            if (b && !g.getNestedEditable(b.wrapper, c.data.element)) return b.fire("doubleclick", {
        ...
        b.on("toDataFormat", function(b) {
            ...
            b.data.dataValue.forEach(function(c) {
                ...
                if ("data-cke-widget-id" in b) {
                    if (b = a.instances[b["data-cke-widget-id"]]) d = c.getFirst(g.isParserWidgetElement), f.push({
                        wrapper: c,
                        element: d,
                        widget: b,
                        editables: {}
    ...
    g.prototype = {
        ...
        destroy: function(a) {
            ...
            a || ("0" == this.element.data("cke-widget-keep-attr") && this.element.removeAttribute("data-widget"), this.element.removeAttributes(["data-cke-widget-data", "data-cke-widget-keep-attr"]),
        ...
        initEditable: function(a, b) {
            ...
            return c && c.is(CKEDITOR.dtd.$editable) ? (c = new q(this.editor, c, {
                ...
                b.pathName), this.editor.focusManager.add(c), c.on("focus", E, this), CKEDITOR.env.ie && c.on("blur", D, this), c._.initialSetData = !0, c.setData(c.getHtml()), !0) : !1
        },
        ...
        updateDragHandlerPosition: function() {
            ...
            c && b.x == c.x && b.y == c.y || (c = a.checkDirty(), a.fire("lockSnapshot"), this.dragHandlerContainer.setStyles({
                    ...
                    left: b.x + "px",
                    display: "block"
                }), a.fire("unlockSnapshot"), !c && a.resetDirty(), this._.dragHandlerOffset =
                b)
        }
    };
    ...
    (function() {
        ...
        function b(a, b, e) {
            return e && this.checkElement(a) ? (a = e.widgets.getByElement(a, !0)) && a.checkStyleActive(this) : !1
        }
